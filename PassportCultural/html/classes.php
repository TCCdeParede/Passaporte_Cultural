...
<body>
    ...
    <form action="" method="get" class="content">
        ...
        <select name="classe" id="classe">
            <option value="1eaa">1eaa</option>
            <option value="3dsb">Opção 2</option>
...
<!--  
    <div class="content">
        <h1>Tabelas de Turmas</h1>

       
        <table>
            <caption>Turmas de ADM</caption>
            <thead>
                <tr>
                    <th>Ano</th>
                    <th>Turma A</th>
            ...
            <tbody>
                <tr>
                    <td>1º Ano</td>
                    <td><a href="../listar/listargeral.php?classe=1eaa">ADM 1º A</a></td>
                    <td><a href="../listar/listargeral.php?classe=1eab">ADM 1º B</a></td>
                </tr>
                <tr>
                    <td>2º Ano</td>
                    <td><a href="../listar/listargeral.php?classe=2eaa">ADM 2º A</a></td>
                    <td><a href="../listar/listargeral.php?classe=2eab">ADM 2º B</a></td>
                </tr>
                <tr>
                    <td>3º Ano</td>
                    <td><a href="../listar/listargeral.php?classe=3eaa">ADM 3º A</a></td>
                    <td><a href="../listar/listargeral.php?classe=3eab">ADM 3º B</a></td>
                </tr>
            </tbody>
        </table>

        <table>
            <caption>Turmas de DS</caption>
            <thead>
                <tr>
                    <th>Ano</th>
                    <th>Turma A</th>
            ...
            <tbody>
                <tr>
                    <td>1º Ano</td>
                    <td><a href="../listar/listargeral.php?classe=1dsa">DS 1º A</a></td>
                    <td><a href="../listar/listargeral.php?classe=1dsb">DS 1º B</a></td>
                </tr>
                <tr>
                    <td>2º Ano</td>
                    <td><a href="../listar/listargeral.php?classe=2dsa">DS 2º A</a></td>
                    <td><a href="../listar/listargeral.php?classe=2dsb">DS 2º B</a></td>
                </tr>
                <tr>
                    <td>3º Ano</td>
                    <td><a href="../listar/listargeral.php?classe=3dsa">DS 3º A</a></td>
                    <td><a href="../listar/listargeral.php?classe=3dsb">DS 3º B</a></td>
                </tr>
            </tbody>
        </table>
    </div>
