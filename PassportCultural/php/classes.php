...
<head>
    ...
    <style>
        ...
        .menu {
            ...
            /* Centraliza horizontalmente o conteúdo do menu */
            padding: 10px 0;
            /* Adiciona padding superior e inferior */
            box-sizing: border-box;
            /* Inclui o padding na largura total do menu */
            position: fixed;
            /* Fixa o menu no topo da página */
            top: 0;
        ...
        @media (max-width: 768px) {
            body {
                ...
                justify-content: center;
                /* Alinha verticalmente em dispositivos móveis */
                padding: 20px;
            ...
            .menu {
                padding: 10px 0;
                /* Garante que o padding não cause espaçamento indesejado */
                margin: 0;
                /* Remove margens se houver */
                position: fixed;
                /* Fixa o menu no topo da página */
                top: 0;
                /* Alinha o menu ao topo */
                ...
                /* Alinha o menu à esquerda */
                width: 100%;
                /* Garante que o menu ocupe toda a largura da tela */
            }
            ...
            table {
                width: 100%;
                /* Aumenta a largura da tabela para ocupar toda a largura disponível */
                max-width: none;
                /* Remove a largura máxima em dispositivos móveis */
                margin: 20px 0;
                /* Adiciona margens verticais */
            }
            ...
            caption {
                font-size: 1.4em;
                /* Ajusta o tamanho da fonte do caption */
            }
        }
...
<body>
    ...
    <tr>
        ...
        // Verifica se 'classe' está definido no array $_GET e define um valor padrão caso não esteja
        // $classe = isset($_GET['classe']) ? $_GET['classe'] : 'nulo';

        // // Evita a execução da consulta se o valor for 'nulo'
        // if ($classe !== 'nulo') {
        //     $query = mysqli_query($sql, "SELECT * FROM alunos WHERE NomeTu='$classe' ORDER BY Nome ASC;");
        ...
        //     }
        // } else {
        //     echo "<tr><td colspan='6'>Por favor, selecione uma classe.</td></tr>";
        // }
        // 
        ?>
</body>
